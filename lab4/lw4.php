...
function isLuckyTicket($ticket): bool {
    ...
    return $sumOfDigitsPart1 === $sumOfDigitsPart2;
}
...
function isCorrectTicket($ticket): bool {
...
if (isset($_POST["ticket1"]) && isset($_POST["ticket2"])){
    ...
    if (isCorrectTicket($ticket1) && isCorrectTicket($ticket2) && $ticket1 < $ticket2) {
        $start = (int)$ticket1;
        $end = (int)$ticket2;
